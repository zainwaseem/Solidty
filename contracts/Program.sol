...
function addProgram(string memory _programCode, string memory _programName,string memory _programType) public{
...
function editProgram(string memory _prevProgramCode, string memory _newProgramCode, string memory _programName,string memory _programType) public {
    require(Admin1(admin).checkAdmin(msg.sender),"You are not Admin");
