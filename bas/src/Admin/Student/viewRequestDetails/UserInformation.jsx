 ...
 const [updateStudentContract, setUpdateStudentContract] = useState(null);
  ...
  const fetchData = async () => {
    try {
      ...
      const contract1 = await UpdateStudentContract(web3Instance);
      if (contract) {
        setAddress(storedAddress);
        setUpdateStudentContract(contract1);
        const studentAddr =await localStorage.getItem("Student_address");
          const studentData = await contract.methods.getStudentRequestDetails(studentAddr).call({ from: storedAddress });
          if(studentData){
            const reasonOfUpdate =   await contract.methods.getStatus(studentAddr).call({ from: address }) 
...
const handleDisapproval = async() => {
 ...
 <ThemeProvider theme={theme}>
            ...
            <div className="Student">
                ...
                <tr>
                    ...
                    <tr>
                        ...
                        <h3 className="text-center headings" >Reason Of Update</h3>
                        </td>
                    </tr>
                    <tr>
                        <td colSpan={4}>
                    ...
                    <tr>
                        <td colSpan={4}>
                        <h3 className="text-center headings" >Write Comments</h3>
                        </td>
                    </tr>
                    <tr>
  <td colSpan={4}>
  ...
  />
                    ...
                    <tr>
                        <td colSpan={2}>
                        <Button  variant="contained" onClick={() => handleApproval()}>Approve</Button>
                         
                        </td>
                        <td colSpan={2}>
                        <Button  variant="contained" onClick={() => handleDisapproval()}>DisApprove</Button>
