...
function StudentsList({searchTerm}) {
    ...
    const fetchData = async () => {
      try {
        ...
        if (contract) {
        const studentsArr = await contract.methods.getStudentsList().call({ from: storedAddress });
...
student.Id.toLowerCase().includes(searchTerm.toLowerCase())
    ...
    return (
      <div className="panel-wrapper">
        ...
        <h1 className="text-center headings">Students List</h1>
        <table >
          <thead>
            <tr>
                ...
                <tr key={student.Id}>
                  ...
                  <td>
                    ...
                    <td>                        
                                         ...
                                         <Button  variant="contained"  onClick={() => handleView(student.addr)}>View History</Button>
                                            </Link>
                                        </td>
                </tr>
              ))
